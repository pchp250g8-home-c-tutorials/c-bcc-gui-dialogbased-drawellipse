DrawEllipse. C Tutorials. Rad Studio IDE. Windows API. 2D Graphics. GDI. DialogBased GUI Application. 
...
DrawEllipse. Занятия по C. ИС Embarcadero Rad Studio. Windows API. 2D Графика. GDI. 
